...
namespace TAP21_22.AuctionSite.Testing {
    internal static class Configuration {
        internal const string StudentSpace = @"C:\Users\mules\source\repos\TAP21_22.AuctionSite.Implementation";
        internal const string CurrentStudent = "Mule";
        internal static Dictionary<string, string> Implementations = new Dictionary<string, string>() {
            ["Mule"] = @"\TAP21_22.AuctionSite.Logic\bin\Debug\net5.0\TAP21_22.AuctionSite.Logic.dll"
        };
        ...
        internal const string ConnectionString =
            @"Data Source=DESKTOP-UAMMC60\SQLEXPRESS;Initial Catalog=" + CurrentStudent+"DB666;Integrated Security=True;";
    }
